...
public class CommonSINT {
	...
	public static void printEndPageChecker (PrintWriter out, String previousPhase, int esProfesor, String curso, String lang)
	{
		...
		out.println("<input class='back' type='submit' value='"+Msgs.getMsg(Msgs.CB02,lang)+"' onClick='document.forms[0].screenP.value=\""+previousPhase+"\"'>"); //CB02=Atrás
		out.println("<input class='home'  type='submit' value='"+Msgs.getMsg(Msgs.CB01,lang)+"' onClick='document.forms[0].screenP.value=\"0\"'>"); //CB01=Inicio
		out.println("</form>");
